...
switch(item_Choice.toUpperCase()){
    case 'A':
        item = 'Pepsi Cola'; 
        Tot_price = 30 * qty; //12 x the quantity that was input Ex: 12 x 3 = 36
    ...
    case 'B':
        item = 'Coca Cola';
        Tot_price = 30 * qty;  //14 x the quantity that was input Ex: 14 x 3 = 42
        //display the item and the quantity using the console.log, backticks, $, and {}.
        console.log(`The Total Price of the order ${item_Choice} x ${qty}: ${Tot_price}`)
        break;  //Use break so that it won't display everything.
    case 'C':
    ...
    case 'D':
        item = 'Orange (per kg)';
        Tot_price = 120 * qty;  //100 x the quantity that was input Ex: 100 x 3 = 300
        //display the item and the quantity using the console.log, backticks, $, and {}.
        console.log(`The Total Price of the order ${item_Choice} x ${qty}: ${Tot_price}`)
        break;  //Use break so that it won't display everything.
    case 'E':
        item = 'Hotdogs (per kg)';
        Tot_price = 180 * qty;  //120 x the quantity that was input Ex: 120 x 3 = 360
        //display the item and the quantity using the console.log, backticks, $, and {}.
        console.log(`The Total Price of the order ${item_Choice} x ${qty}: ${Tot_price}`)
        break;  //Use break so that it won't display everything.
